            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 space-y-8">
                ...
                <p className="text-lg md:text-xl text-gray-600">
                  Experience our new AI chat interface powered by OpenAI. Ask
                  questions, get information, and have natural conversations
                  ...
                  <div className="p-4">
                    <div className="flex flex-col space-y-4">
                      ...
                      <div className="flex justify-end">
                        <div className="bg-black text-white rounded-lg rounded-br-none p-3 max-w-[80%]">
                      ...
                      <div className="flex justify-start">
                        <div className="bg-gray-200 text-gray-800 rounded-lg rounded-bl-none p-3 max-w-[80%]">
                          ...
                          being explicitly programmed. It works by analyzing
          ...
          <div className="container px-4 mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-[700px] mx-auto">
                Our AI chat interface provides a seamless and intuitive
                experience for communicating with our AI assistant.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="border-gray-200 bg-gradient-to-b from-white to-gray-50 shadow-md hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Clean, minimalist design with message bubbles that clearly
              ...
              <Card className="border-gray-200 bg-gradient-to-b from-white to-gray-50 shadow-md hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Fully responsive layout that works seamlessly on both
              ...
              <Card className="border-gray-200 bg-gradient-to-b from-white to-gray-50 shadow-md hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="mb-4">
                    <History className="h-10 w-10 text-black" />
                  </div>
                  <CardTitle className="text-black">
              ...
              <Card className="border-gray-200 bg-gradient-to-b from-white to-gray-50 shadow-md hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Leverages OpenAI's powerful language models to provide
            ...
            <div className="bg-gradient-to-r from-gray-100 to-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200">
              <div className="max-w-3xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-black">
                  Ready to Try Our AI Chat?
                </h2>
                <p className="text-lg md:text-xl mb-8 text-gray-600">
                  Experience the power of AI conversation with our intuitive
                  chat interface. No login required to get started.
                </p>
